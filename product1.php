    ...
    <body>
        ...
        <section id="product" class="section-p1">
            <div class="productImage">
                <img src="img/products/p1.jpg" width="100%" id="mainImage" alt="">

                <div class="smallImages">
                    <div class="smallImageCol">
                        <img src="img/products/p1.jpg" width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
                        <img src="img/products/p1.jpg" width="100%" class="smallImage" alt="">
                    </div>
            ...
            <div class="productDescript">
                <h6>Womens / Runners</h6>
                <h4>Brooks Glycerin 19</h4>
                <h2>$180</h2>
                <select>
                ...
                <span>Step into your softest run ever. With plenty of super soft DNA LOFT cushioning underfoot, the Glycerin 19 delivers premium comfort mile after mile. 
                    More DNA LOFT than ever for extreme underfoot softness.
                    Updated materials in the mesh upper provide a better fit.</span>
                <h6 class="seller" style="margin-bottom: 10px;">Sold by: Molly Esmonde</h6>
