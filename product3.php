    ...
    <body>
        ...
        <section id="product" class="section-p1">
            <div class="productImage">
                <img src="img/products/p3.jpg" width="100%" id="mainImage" alt="">

                <div class="smallImages">
                    <div class="smallImageCol">
                        <img src="img/products/p3.jpg" width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
                        <img src="img/products/p3.jpg" width="100%" class="smallImage" alt="">
                    </div>
            ...
            <div class="productDescript">
                ...
                <span>Have you ever wanted a taste of the PTI lifestyle?</span>
                <p></p>
                <span>Well now you can!</span>
                <p></p>
                <span>For only $100 enjoy the yelling and ludicrious lifestyle of an ADFA PTI</span>
                <h6 class="seller">Sold by: Fraser Morgan</h6>
