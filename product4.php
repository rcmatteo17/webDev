    ...
    <body>
        ...
        <section id="product" class="section-p1">
            <div class="productImage">
                <img src="img/products/p4.jpg" width="100%" id="mainImage" alt="">

                <div class="smallImages">
                    <div class="smallImageCol">
                        <img src="img/products/p4.jpg" width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
                        <img src="img/products/p4.jpg" width="100%" class="smallImage" alt="">
                    </div>
            ...
            <div class="productDescript">
                <h6>Electronics</h6>
                <h4>35" Asus Monitor</h4>
                <h2>$675</h2>
                <button class="normal">Add To Cart</button>
                <h4>Product Details</h4>
                <span>35-inch WQHD (3440x1440) 1800R curved gaming monitor with fast 100Hz refresh rate designed for professional gamers and immersive gameplay</span>
                <p></p>
                <span>ASUS Extreme Low Motion Blur (ELMB ™) technology enables a 1ms response time (MPRT) together with Adaptive-sync, eliminating ghosting and tearing for sharp gaming visuals with high frame rates.</span>
                <p></p>
                <span>Adaptive-Sync technology to eliminate screen tearing and choppy frame rates</span>
                <h6 class="seller">Sold by: Alex Hill</h6>
