    ...
    <body>
        ...
        <section id="product" class="section-p1">
            <div class="productImage">
                <img src="img/products/p5.jpg" width="100%" id="mainImage" alt="">

                <div class="smallImages">
                    <div class="smallImageCol">
                        <img src="img/products/p5.jpg" width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
                        <img src="img/products/p5.jpg" width="100%" class="smallImage" alt="">
                    </div>
            ...
            <div class="productDescript">
                ...
                <span>Look the part of a Musical Theatre Pro with these pre-loved Black Court Shoes</span>
                <p></p>
                <span>Additionally, these provide a perfect substitute to any black court shoe based uniform footwear for those with sizing or equipment wear issues.</span>
                <h6 class="seller">Sold by: Odette McCall</h6>
