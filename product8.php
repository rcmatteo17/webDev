    ...
    <body>
        ...
        <section id="product" class="section-p1">
            <div class="productImage">
                <img src="img/products/p8.jpg" width="100%" id="mainImage" alt="">

                <div class="smallImages">
                    <div class="smallImageCol">
                        <img src="img/products/p8.jpg" width="100%" class="smallImage" alt="">
                    </div>
                    <div class="smallImageCol">
                        <img src="img/products/p8.jpg" width="100%" class="smallImage" alt="">
                    </div>
            ...
            <div class="productDescript">
                <h6>Clothing</h6>
                <h4>Phenix Ski Overalls</h4>
                <h2>$45</h2>
                <button class="normal">Add To Cart</button>
                <h4>Product Details</h4>
                <span>Phenix is
                    a well and long established brand from Japan, introducing top class products,
                    entrusted and beloved by top class athletes and general users around the world.</span>
                <p></p>
                <span>Phenix originated from Japan, has now grown into a successful and prestigious sportswear brand believing there's no boundaries of our potential when we set free our minds and souls.</span>
