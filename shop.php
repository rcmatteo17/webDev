        ...
        <section id="product2" class="section-p1">
            ...
            <div class="pro-container">
                ...
                <div class="pro">
                    ...
                    <div class="des">
                        <span>Damiel Abrams</span>
                        <h5>iPad Air 4th Gen</h5>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro">
                    ...
                    <div class="des">
                        <span>tom O'Really</span>
                        <h5>2013 Nissan Pulsar</h5>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro">
                    ...
                    <div class="des">
                        <span>Maddy Zlateff</span>
                        <h5>Cropped Denim Jacket</h5>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro">
                    ...
                    <div class="des">
                        <span>John Cotora</span>
                        <h5>Maurice Cole 6'10 Surfboard with Case</h5>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
